        ...
        <div class="row">
            <div class="col-lg-5 col-md-12">
                <div class="heading-text heading-section mt-5">
                    <h2>Bienvenue sur votre espace Garden Studio <span style="color: #57233A"><?= $user['prenom'] ?> <?= $user['nom'] ?></span></h2>
                </div>
                <p>C'est ici que vous pourrez piloter vos projets musicaux, gérer votre compte, vos réservations, ...
                </p>
                <a href="mesprojets" class="btn btn-dark">Mes projets</a>
                <a href="mesreservations" class="btn btn-dark">Mes réservations</a>
            </div>
            <div class="col-lg-6 col-md-12 m-t-50">
                <div class="heading-text heading-section mt-5">
